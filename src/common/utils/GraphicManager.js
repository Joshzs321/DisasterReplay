...
class GraphicManager {
    ...
    createPolyline(options = CesiumPolyline.defaultStyle) {
        ...
        // 只要点击画线按钮就会生成一个id
        // 但是点击之后不一定会绘制，或者绘制没有结束就点了绘制其他的
        // 所有后面要进行判断，manager中是否有画的id
    ...
    createPolygon(options = CesiumPolygon.defaultStyle) {
        ...
        // 这是自定义的一个实体类，生成实例就自动调用自身的create方法
    ...
    addEventListener() {
        ...
        const clickHandler = function (e) {
            ...
            // 开始画线、画面的地方=>先画点，再利用callbackProperty
