...
xp.algorithm = {},
    ...
    xp.algorithm.fineArrow = function (tailPoint, headerPoint) {
        ...
        i = n * neckWidthFactor,
            ...
            s = n * headWidthFactor,
            //头部宽度因子
            a = P.PlotUtils.getThirdPoint(r, e1, P.Constants.HALF_PI, g, !0),
            l = P.PlotUtils.getThirdPoint(r, e1, P.Constants.HALF_PI, g, !1),
            u = P.PlotUtils.getThirdPoint(e1, r, headAngle, s, !1),
            c = P.PlotUtils.getThirdPoint(e1, r, headAngle, s, !0),
            p = P.PlotUtils.getThirdPoint(e1, r, neckAngle, i, !1),
            h = P.PlotUtils.getThirdPoint(e1, r, neckAngle, i, !0),
            d = [];
        d.push(a[0], a[1], p[0], p[1], u[0], u[1], r[0], r[1], c[0], c[1], h[0], h[1], l[0], l[1], e1[0], e1[1]);
